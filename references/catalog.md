...
课程编号是稳定 ID，不是必修顺序。`alpha` 已有独立 lesson 和实操；`beta` 已有可教大纲与最小实验，尚未完成全部 lesson 化。
...
| ① | AI 世界地图 | 分清模型、厂商、API、Agent、Token、Context、Tool、MCP 与 Skill | alpha |
...
| ⑥ | 从 Prompt 到 Graph | 判断 Prompt、Context、Harness、Loop、Graph 各解决什么问题 | alpha |
| ⑦ | AI 产品 Sense | 从用户、Context、行动、反馈与价值判断 AI 产品是否值得做 | alpha |

## 推荐规则

- 完全不知道从哪开始，但已经装好 Agent：推荐 ① 或 ④；想尽快获得正反馈时优先 ④。
- 不敢碰终端或看不懂 localhost：推荐 ⑧。
- 有想法但经常一句 Prompt 让 AI 做完：推荐 ③。
- 想保住项目、参加开源或完成校友墙：推荐 ②。
- 想理解并亲手构建 Agent：推荐 ⑩；不先要求学完 ⑨，概念按需插入。
- 已有能跑但不敢改的项目：推荐 ⑤。
